...
@section('page-title', 'Editar Portería - Equipamiento')
...
@section('content')
  <div class="container">
    <h1>Editar Equipamiento de Portería: {{ $gate->description }}</h1>

    <form action="{{ route('admin.map.gate.submit.equipment', $gate->id) }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('POST')
