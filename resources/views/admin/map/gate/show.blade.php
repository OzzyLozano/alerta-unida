...
@section('content')
  ...
  @endif
  <a href="{{ route('admin.map.gate.add.equipment', $gate->id) }}">Agregar equipo a esta portería</a>

  <div class="my-4">
    <h2>{{ $gate->description }}</h2>
    <img src="{{ $gate->img_path }}" alt="img.jpg" style="width: 400px; height: auto;">
    <a href="{{ route('admin.map.gate.edit', $gate->id) }}" class="btn btn-secondary">Editar Portería</a>
